...
function ProjectDetail({ project, prevProject, nextProject, breakPoints }) {
  return (
    <div className='project--detail container'>
      <div className='project__image--detail'>
        <img alt='project hero' src={project.hero} />
      </div>
        ...
        <div className='desktop__right'>
          <div className='project__background'>
            ...
            {project.frontendMentor && (
              <p className='project__text project__text--italic'>
          ...
          <div className='project__previews'>
            ...
            <div className='project__image--detail project__preview'>
              <img alt='project preview' src={project.preview1} />
            </div>

            {project.preview2 && (
              <div className='project__image--detail project__preview'>
                <img alt='project preview' src={project.preview2} />
              </div>
            )}
          </div>
        </div>
      ...
      <div className='project__nav'>
        <Link to={`/${prevProject.path}`} className='nav__previous'>
          <img alt='previous project' src={arrowLeft} />
          <h3>{prevProject.heading}</h3>
          <p>Previous Project</p>
        </Link>

        <Link to={`/${nextProject.path}`} className='nav__next'>
          <img alt='next project' src={arrowRight} />
          <h3>{nextProject.heading}</h3>
          <p>Next Project</p>
        </Link>
      </div>
    </div>
