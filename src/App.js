...
function App() {
  ...
  return (
    <Router basename={process.env.PUBLIC_URL}>
      <Nav breakPoints={breakPoints} active={active} setActive={setActive} />
      ...
      <Fragment>
        ...
        <Switch>
          <Route
            exact
            path='/'
            render={() => <Home breakPoints={breakPoints} setActive={setActive} />}
          />

          <Route
            exact
            path='/portfolio'
            render={() => <Portfolio breakPoints={breakPoints} />}
          />
          ...
          <Route path='/contact' render={() => <Contact breakPoints={breakPoints} />} />
        </Switch>
      </Fragment>

      <Route
        exact
        path={['/', '/portfolio', '/manage', '/bookmark', '/insure', '/fylo']}
        render={() => <CTA active={active} setActive={setActive} />}
      />
